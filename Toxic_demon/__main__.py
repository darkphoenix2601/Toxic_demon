...
from Toxic_demon.modules import ALL_MODULES
from Toxic_demon.modules.helper_funsc.chat_status import is_user_admin
from Toxic_demon.modules.helper_funsc.misc import paginate_modules
...
buttons = [
        ...
        InlineKeyboardButton(
            text="𝘈𝘥𝘥 𝘮𝘦 𝘯𝘰𝘸➕", url="t.me/Toxic_demon_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="𝘔𝘪𝘴𝘴 𝘈𝘬𝘴𝘩𝘪 𝘭𝘰𝘨𝘴❤",url=f"https://t.me/Toxic_demon_logs"),
    ],
    [
        InlineKeyboardButton(
            text="𝘶𝘱𝘥𝘢𝘵𝘦𝘴🤞", url=f"https://t.me/phoenix_music_new"
        ),
        InlineKeyboardButton(
            text="𝘚𝘶𝘱𝘱𝘰𝘳𝘵😍", url=f"https://t.me/phoenix_music_suport"
        ),
    ],
    [
        InlineKeyboardButton(text="𝘩𝘦𝘭𝘱 𝘢𝘯𝘥 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴❓", callback_data="help_back"
        ),
    ],
]
...
LIVVY_IMG = "https://telegra.ph/file/feca385a457d267336767.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Toxic_demon.modules." + module_name)
...
1. `Firstly Add [Me](t.me/Toxic_demon_bot?startgroup=true) to your group and`
2. `After Adding Promote me Manually with Full Rights for Faster Experience.`
3. `Than Send` `/admincache@Toxic_demon_bot` `in that Chat to Refresh Admin List in My Database.`""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
               [
