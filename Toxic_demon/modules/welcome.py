...
import Toxic_demon.modules.sql.welcome_sql as sql
import Toxic_demon
...
from Toxic_demon.modules.helper_funsc.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                creator = None
                if not Toxic_demon.ALLOW_CHATS:
