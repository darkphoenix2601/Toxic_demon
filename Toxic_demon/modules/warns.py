...
import telegram
from Toxic_demon import TIGERS, WOLVES, dispatcher
from Toxic_demon.modules.disable import DisableAbleCommandHandler
from Toxic_demon.modules.helper_funsc.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Toxic_demon.modules.helper_funsc.extraction import (
    extract_text,
    extract_user,
...
from Toxic_demon.modules.helper_funsc.string_handling import split_quotes
from Toxic_demon.modules.log_channel import loggable
from Toxic_demon.modules.sql import warns_sql as sql
