...
from Toxic_demon import BOT_ID
from Toxic_demon.conf import get_int_key, get_str_key

# from Toxic_demon.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
from Toxic_demon.pyrogramee.telethonbasics import is_admin
from Toxic_demon.events import register
from Toxic_demon import MONGO_DB_URI 
from pymongo import MongoClient
from Toxic_demon.modules.sql_extended.nsfw_watch_sql import (
    add_nsfwatch,
...
__help__ = """
<b> Group Guardian: </b>
✪ Akshi can protect your group from NSFW senders, Slag word users and also can force members to use English
<b>Commmands</b>
